...
export const sttProviderChoices: readonly ProviderChoiceDescriptor[] = [
  ...
  },
  {
    ...
    detail: 'Real Groq transcription request path; network execution is credential-gated.',
  },

  {
    ...
    providerType: 'local',
    requiresCredential: false,
    detail: 'Selects the OS-appropriate local sidecar: macOS MLX/WhisperKit candidates, Windows whisper.cpp/ONNX candidates, never Windows MLX.',
  },
  {
    id: 'mlx-audio-stt',
    label: 'MLX Audio',
...
export const llmProviderChoices: readonly ProviderChoiceDescriptor[] = [
  ...
  },
  {
    ...
    providerType: 'local',
    requiresCredential: false,
    detail: 'OS local text/vision sidecar path; Windows selects llama.cpp/ONNX rather than MLX.'
  },
  {
